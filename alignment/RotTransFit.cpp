...
double xt0 = 31.499999999999957;//NEW
// double xt0 = 353.49999999999955;//SEW
// double xt0 = 370.6999999999995;//L2 cone
// double xt0 = 593.6980669997034;//L2A2
...
#define ERR(i) sqrt(gsl_matrix_get(covar,i,i))
  ...
  for (int i=0; i<nd; i++) {
    if(faces[data.fid[i]].ftype == 2){//cylinder
      // double a  = FIT(0), Ca = cos(a), Sa = sin(a);
      // double b  = FIT(1), Cb = cos(b), Sb = sin(b);
      // double g  = FIT(2), Cg = cos(g), Sg = sin(g);
      // double xt = FIT(3);
      // double yt = FIT(4);
      // double zt = FIT(5);
      ...
      // std::cout<<x_px*x_px + x_py*x_py + x_pz*x_pz<<std::endl;
